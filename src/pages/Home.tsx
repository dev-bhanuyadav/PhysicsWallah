...
const IMG = {
  logo:          `https://th.bing.com/th/id/OIP.8vIGm3BuOD31_XaWr2FhMgHaHa?w=175&h=180&c=7&r=0&o=7&pid=1.7&rm=3`,
...
export default function Home() {
  ...
  const handleVerifyOtp = async () => {
    ...
    if (r.ok) {
      if ((r as any).token) {
        const enc = await encryptToken((r as any).token);
        sessionStorage.setItem('pw_token', enc);
      }
    ...
    <div className="min-h-screen bg-white font-['Inter',sans-serif] text-[#1F2937]">
      ...
      >
        ...
        <div className="max-w-[900px] mx-auto relative h-[260px] sm:h-[320px] mt-4">
          ...
          {/* Girl speech bubble - Hidden to avoid duplication as per request */}
